...
## Load model2nya
model1 = joblib.load("models-novol/model1.jl")
model2 = joblib.load("models-novol/model2.jl")
model3 = joblib.load("models-novol/model3.jl")
model4 = joblib.load("models-novol/model4.jl")
model5 = joblib.load("models-novol/model5.jl")
model6 = joblib.load("models-novol/model6.jl")
model7 = joblib.load("models-novol/model7.jl")
